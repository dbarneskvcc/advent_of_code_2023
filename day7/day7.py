...
class Day7:
    ...
    def solve_problem_2(self):
        ...
        for line in lines:
            ...
            hand_stats = sorted(hand_stats.values(), reverse=True)
            if len(hand_stats) > 0:
                hand_stats[0] += joker_counter
            else:
                hand_stats.append(joker_counter)
        ...
        for name, hand_info in hand_types.items():
            ...
            if len(hand_info) > 1:
                sorted_hand_info = self.sort_hands_pt2(hand_info)
            else:
                sorted_hand_info = hand_info
    ...
    def sort_hands_pt2(self, hand_info):
        """Sort hands based on value"""
